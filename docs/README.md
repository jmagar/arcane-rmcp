...
This directory contains focused guides for operating, adapting, testing, and releasing an `rustcane`-derived MCP server.
...
| `contracts/` | Durable JSON Schema and rustcane contracts (e.g. scaffold intent schema). |
