...
usage() {
  cat <<'USAGE'
Install rarcane from GitHub Releases.

Environment:
  INSTALL_DIR      Destination directory (default: ~/.local/bin)
  ARCANE_RMCP_VERSION Release tag such as v0.4.0 (default: latest)
  ARCANE_RMCP_REPO    GitHub repo owner/name (default: jmagar/arcane-rmcp)
USAGE
}
